...
# 37 "log.cpp"
int main() {
    { printf("[%s : %s : %d] ", "log.cpp", __func__, 38); printf("hello kaikeba"); printf("\n"); };
    int kaikeba_cs = 9973;
    kaikeba_cs = 10000;
    { printf("[%s : %s : %d] ", "log.cpp", __func__, 41); printf("kaikeba_cs = %d", kaikeba_cs); printf("\n"); };
    int a = 1, b = 2, c = 3;
    printf("a = %d, b = %d, c = %d\n", a, b, c);
    { printf("[%s : %s : %d] ", "log.cpp", __func__, 44); printf("a = %d, b = %d, c = %d", a, b, c); printf("\n"); };
    { printf("[%s : %s : %d] ", "log.cpp", __func__, 45); printf("a = %d, b = %d, c = %d", a, b, c); printf("\n"); };
    return 0;
}
